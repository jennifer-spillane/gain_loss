...
flush.console()
mettree <- read.tree("/mnt/lustre/macmaneslab/jlh1023/metazoa_matrix/modeling/tree.new")
...
important <- t(apply(AA, 1, function(x, levels, Nsim) summary(factor(x, levels))/Nsim, levels = levels(factor(mettree$states)), Nsim=1000))
